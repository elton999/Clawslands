...
class WalterFall extends GameObject{
	public override function start() {
		super.start();
		Assets.loadImage("Content_Sprites_walterfall", function (done:Image){
			this.Sprite = done;
			this.animation.start("Content_Sprites_walterfall_json");
		});
	}
