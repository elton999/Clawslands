...
class HUD extends GameObject{
	public override function render(g2:Graphics) {
		...
		// life
		g2.drawSubImage(this.Sprite, this.Position.x + 8, this.Position.y + 5, 0,72, 10, 9);
		g2.drawSubImage(this.Sprite, this.Position.x + 19, this.Position.y + 5, 0,72, 10, 9);
		g2.drawSubImage(this.Sprite, this.Position.x + 30, this.Position.y + 5, 0,72, 10, 9);
